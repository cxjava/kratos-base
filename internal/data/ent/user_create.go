...
// SetAge sets the "age" field.
func (u *UserUpsert) SetAge(v int32) *UserUpsert {
...
func (u *UserUpsert) AddAge(v int32) *UserUpsert {
...
// SetAge sets the "age" field.
func (u *UserUpsertOne) SetAge(v int32) *UserUpsertOne {
...
// AddAge adds v to the "age" field.
func (u *UserUpsertOne) AddAge(v int32) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.AddAge(v)
	})
}
...
// SetAge sets the "age" field.
func (u *UserUpsertBulk) SetAge(v int32) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetAge(v)
	})
}
...
// AddAge adds v to the "age" field.
func (u *UserUpsertBulk) AddAge(v int32) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.AddAge(v)
	})
}
